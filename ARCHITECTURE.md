...
1. **Ingestion & Scraping**: `thehelpers/` handles scraping of publicly available historical papers from thehelpers.tech and deduplicates/caches them as raw documents.
