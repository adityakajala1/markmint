...
from backend.models.core import Base, Concept, ConceptAlias, MappingConfidence, ConceptStatus
from backend.services.concept.engine import ConceptIntelligenceEngine
from backend.services.concept.normalizer import ConceptNormalizer
...
def test_evidence_segregation(db_session):
    from backend.models.core import Document, StudyEvidence
